export default {
  __version: '7.0.0-rc.2',
  'hydrator-user_totp_recovery_code_4000-full-false': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError, user_3, user_4) {
  ...
  'hydrator-user_totp_recovery_code_4000-full-true': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError, user_11, user_12) {
    // compiled hydrator for entity UserTotpRecoveryCodeEntity ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
  ...
  'comparator-user_totp_recovery_code_4000': function(compareArrays, compareBooleans, compareBuffers, compareObjects, equals) {
    ...
    return function(last, current, options) {
      ...
      if (current.id === null && last.id === undefined) {
        ...
        diff.id = current.id;
      } else if (!equals(last.id, current.id)) {
        diff.id = current.id;
      }
      ...
      if (current.user === null && last.user === undefined) {
        ...
        diff.user = current.user;
      } else if (!equals(last.user, current.user)) {
        diff.user = current.user;
      }
  ...
  'snapshotGenerator-user_totp_recovery_code_4000': function(clone, cloneEmbeddable, processDateProperty, toArray, EntityIdentifier) {
    return function(entity) {
      const ret = {};
      if (typeof entity.id !== 'undefined') {
        ret.id = clone(entity.id);
      }
  ...
  'hydrator-user_totp_recovery_code_4000-reference-false': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError) {
    // compiled hydrator for entity UserTotpRecoveryCodeEntity ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
  ...
  'hydrator-user_totp_recovery_code_4000-reference-true': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError) {
    // compiled hydrator for entity UserTotpRecoveryCodeEntity ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
  ...
  'pkGetterConverted-user_totp_recovery_code_4000': function() {
    // compiled pk getter (with converted custom types) for entity UserTotpRecoveryCodeEntity
    return function(entity) {
      return entity.id;
    }
  },
  'pkSerializer-user_totp_recovery_code_4000': function(getCompositeKeyValue, getPrimaryKeyHash) {
    // compiled pk serializer for entity UserTotpRecoveryCodeEntity
    return function(entity) {
      return '' + entity.id;
    }
  },
  'hydrator-user_totp_3000-full-false': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError, user_21, user_22) {
  ...
  'hydrator-user_totp_3000-full-true': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError, user_29, user_30) {
    // compiled hydrator for entity UserTotpEntity ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
  ...
  'snapshotGenerator-user_totp_3000': function(clone, cloneEmbeddable, processDateProperty, toArray, EntityIdentifier) {
    return function(entity) {
      const ret = {};
      if (typeof entity.id !== 'undefined') {
        ret.id = clone(entity.id);
  ...
  'hydrator-user_totp_3000-reference-false': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError) {
    // compiled hydrator for entity UserTotpEntity ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
  ...
  'hydrator-user_totp_3000-reference-true': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError) {
    // compiled hydrator for entity UserTotpEntity ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
  ...
  'pkGetterConverted-user_totp_3000': function() {
    // compiled pk getter (with converted custom types) for entity UserTotpEntity
    return function(entity) {
      return entity.id;
    }
  },
  'pkSerializer-user_totp_3000': function(getCompositeKeyValue, getPrimaryKeyHash) {
    // compiled pk serializer for entity UserTotpEntity
    return function(entity) {
      return '' + entity.id;
    }
  },
  'hydrator-user_terms_consent_15000-full-false': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError, user_39, user_40, terms_41, terms_42) {
  ...
  'hydrator-user_terms_consent_15000-full-true': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError, user_50, user_51, terms_52, terms_53) {
    // compiled hydrator for entity UserTermsConsentEntity ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
  ...
  'snapshotGenerator-user_terms_consent_15000': function(clone, cloneEmbeddable, processDateProperty, toArray, EntityIdentifier) {
    return function(entity) {
      const ret = {};
      if (typeof entity.id !== 'undefined') {
        ret.id = clone(entity.id);
  ...
  'hydrator-user_terms_consent_15000-reference-false': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError) {
    // compiled hydrator for entity UserTermsConsentEntity ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
  ...
  'hydrator-user_terms_consent_15000-reference-true': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError) {
    // compiled hydrator for entity UserTermsConsentEntity ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
  ...
  'pkGetterConverted-user_terms_consent_15000': function() {
    // compiled pk getter (with converted custom types) for entity UserTermsConsentEntity
    return function(entity) {
      return entity.id;
    }
  },
  'pkSerializer-user_terms_consent_15000': function(getCompositeKeyValue, getPrimaryKeyHash) {
    // compiled pk serializer for entity UserTermsConsentEntity
    return function(entity) {
      return '' + entity.id;
    }
  },
  'hydrator-user_passkey_2000-full-false': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError, user_63, user_64, convertToJSValue_transports, convertToDatabaseValue_transports) {
  ...
  'hydrator-user_passkey_2000-full-true': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError, user_76, user_77, convertToJSValue_transports, convertToDatabaseValue_transports) {
    // compiled hydrator for entity UserPasskeyEntity ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
  ...
  'snapshotGenerator-user_passkey_2000': function(clone, cloneEmbeddable, processDateProperty, toArray, EntityIdentifier, convertToDatabaseValue_transports) {
    return function(entity) {
      const ret = {};
      if (typeof entity.id !== 'undefined') {
        ret.id = clone(entity.id);
  ...
  'hydrator-user_passkey_2000-reference-false': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError) {
    // compiled hydrator for entity UserPasskeyEntity ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
  ...
  'hydrator-user_passkey_2000-reference-true': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError) {
    // compiled hydrator for entity UserPasskeyEntity ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
  ...
  'pkGetterConverted-user_passkey_2000': function() {
    // compiled pk getter (with converted custom types) for entity UserPasskeyEntity
    return function(entity) {
      return entity.id;
    }
  },
  'pkSerializer-user_passkey_2000': function(getCompositeKeyValue, getPrimaryKeyHash) {
  ...
  'comparator-user_oauth_1000': function(compareArrays, compareBooleans, compareBuffers, compareObjects, equals, compareValues_0) {
    ...
    return function(last, current, options) {
      ...
      if (current.id === null && last.id === undefined) {
        ...
        diff.id = current.id;
      } else if (!compareValues_0(last.id, current.id)) {
        diff.id = current.id;
      }
  ...
  'hydrator-user_5000-full-false': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError, user_oauth_119, user_passkey_120, user_totp_121, user_totp_recovery_code_122) {
  ...
  'hydrator-user_5000-full-true': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError, user_oauth_132, user_passkey_133, user_totp_134, user_totp_recovery_code_135) {
    // compiled hydrator for entity UserEntity ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.sub === null) {
        entity.sub = null;
  ...
  'comparator-user_5000': function(compareArrays, compareBooleans, compareBuffers, compareObjects, equals) {
    ...
    return function(last, current, options) {
      ...
      if (current.sub === null && last.sub === undefined) {
        ...
        diff.sub = current.sub;
      } else if (!equals(last.sub, current.sub)) {
        diff.sub = current.sub;
      }
  ...
  'snapshotGenerator-user_5000': function(clone, cloneEmbeddable, processDateProperty) {
    return function(entity) {
      const ret = {};
      if (typeof entity.sub !== 'undefined') {
        ret.sub = clone(entity.sub);
      }
  ...
  'hydrator-user_5000-reference-false': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError) {
    // compiled hydrator for entity UserEntity ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.sub === null) {
        entity.sub = null;
  ...
  'hydrator-user_5000-reference-true': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError) {
    // compiled hydrator for entity UserEntity ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.sub === null) {
        entity.sub = null;
  ...
  'pkGetterConverted-user_5000': function() {
    // compiled pk getter (with converted custom types) for entity UserEntity
    return function(entity) {
      return entity.sub;
    }
  },
  'pkSerializer-user_5000': function(getCompositeKeyValue, getPrimaryKeyHash) {
    // compiled pk serializer for entity UserEntity
    return function(entity) {
      return '' + entity.sub;
    }
  },
  'hydrator-user_consent_10000-full-false': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError, user_141, user_142, oauth_client_143, oauth_client_144, convertToJSValue_scopes, convertToDatabaseValue_scopes) {
  ...
  'hydrator-user_consent_10000-full-true': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError, user_151, user_152, oauth_client_153, oauth_client_154, convertToJSValue_scopes, convertToDatabaseValue_scopes) {
    // compiled hydrator for entity UserConsentEntity ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
  ...
  'comparator-user_consent_10000': function(compareArrays, compareBooleans, compareBuffers, compareObjects, equals) {
    ...
    return function(last, current, options) {
      ...
      if (current.client === null && last.client === undefined) {
        ...
        diff.client = current.client;
      } else if (!equals(last.client, current.client)) {
        diff.client = current.client;
      }
  ...
  'snapshotGenerator-user_consent_10000': function(clone, cloneEmbeddable, processDateProperty, toArray, EntityIdentifier, convertToDatabaseValue_scopes) {
    return function(entity) {
      const ret = {};
      if (typeof entity.id !== 'undefined') {
        ret.id = clone(entity.id);
  ...
  'hydrator-user_consent_10000-reference-false': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError) {
    // compiled hydrator for entity UserConsentEntity ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
  ...
  'hydrator-user_consent_10000-reference-true': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError) {
    // compiled hydrator for entity UserConsentEntity ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
  ...
  'pkGetterConverted-user_consent_10000': function() {
    // compiled pk getter (with converted custom types) for entity UserConsentEntity
    return function(entity) {
      return entity.id;
    }
  },
  'pkSerializer-user_consent_10000': function(getCompositeKeyValue, getPrimaryKeyHash) {
  ...
  'hydrator-terms_content_14000-full-false': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError, terms_183, terms_184) {
  ...
  'hydrator-terms_content_14000-full-true': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError, terms_192, terms_193) {
    // compiled hydrator for entity TermsContentEntity ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
  ...
  'snapshotGenerator-terms_content_14000': function(clone, cloneEmbeddable, processDateProperty, toArray, EntityIdentifier) {
    return function(entity) {
      const ret = {};
      if (typeof entity.id !== 'undefined') {
        ret.id = clone(entity.id);
  ...
  'hydrator-terms_content_14000-reference-false': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError) {
    // compiled hydrator for entity TermsContentEntity ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
  ...
  'hydrator-terms_content_14000-reference-true': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError) {
    // compiled hydrator for entity TermsContentEntity ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
  ...
  'pkGetterConverted-terms_content_14000': function() {
    // compiled pk getter (with converted custom types) for entity TermsContentEntity
    return function(entity) {
      return entity.id;
    }
  },
  'pkSerializer-terms_content_14000': function(getCompositeKeyValue, getPrimaryKeyHash) {
    // compiled pk serializer for entity TermsContentEntity
    return function(entity) {
      return '' + entity.id;
    }
  },
  'hydrator-revoked_tokens_9000-full-false': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError, oauth_client_205, oauth_client_206, user_207, user_208) {
    ...
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      ...
      if (data.client === null) {
        ...
        if (isPrimaryKey(data.client, true)) {
          entity.client = factory.createReference(oauth_client_205, data.client, { merge: true, convertCustomTypes, normalizeAccessors, schema });
        } else if (data.client && typeof data.client === 'object') {
          entity.client = factory.create(oauth_client_206, data.client, { initialized: true, merge: true, newEntity, convertCustomTypes, normalizeAccessors, schema });
        }
      }
      if (data.user === null) {
        entity.user = null;
        ...
        if (isPrimaryKey(data.user, true)) {
          entity.user = factory.createReference(user_207, data.user, { merge: true, convertCustomTypes, normalizeAccessors, schema });
        } else if (data.user && typeof data.user === 'object') {
          entity.user = factory.create(user_208, data.user, { initialized: true, merge: true, newEntity, convertCustomTypes, normalizeAccessors, schema });
        }
      }
      if (data.expires_at === null) {
        entity.expires_at = null;
  ...
  'hydrator-revoked_tokens_9000-full-true': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError, oauth_client_216, oauth_client_217, user_218, user_219) {
    // compiled hydrator for entity RevokedTokenEntity ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
      ...
      if (data.client === null) {
        ...
        if (isPrimaryKey(data.client, true)) {
          entity.client = factory.createReference(oauth_client_216, data.client, { merge: true, convertCustomTypes, normalizeAccessors, schema });
        } else if (data.client && typeof data.client === 'object') {
          entity.client = factory.create(oauth_client_217, data.client, { initialized: true, merge: true, newEntity, convertCustomTypes, normalizeAccessors, schema });
        }
      }
      if (data.user === null) {
        entity.user = null;
        ...
        if (isPrimaryKey(data.user, true)) {
          entity.user = factory.createReference(user_218, data.user, { merge: true, convertCustomTypes, normalizeAccessors, schema });
        } else if (data.user && typeof data.user === 'object') {
          entity.user = factory.create(user_219, data.user, { initialized: true, merge: true, newEntity, convertCustomTypes, normalizeAccessors, schema });
        }
      }
      if (data.expires_at === null) {
        entity.expires_at = null;
  ...
  'snapshotGenerator-revoked_tokens_9000': function(clone, cloneEmbeddable, processDateProperty, toArray, EntityIdentifier) {
    return function(entity) {
      const ret = {};
      if (typeof entity.id !== 'undefined') {
        ret.id = clone(entity.id);
  ...
  'hydrator-revoked_tokens_9000-reference-false': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError) {
    // compiled hydrator for entity RevokedTokenEntity ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
  ...
  'hydrator-revoked_tokens_9000-reference-true': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError) {
    // compiled hydrator for entity RevokedTokenEntity ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
  ...
  'pkGetterConverted-revoked_tokens_9000': function() {
    // compiled pk getter (with converted custom types) for entity RevokedTokenEntity
    return function(entity) {
      return entity.id;
    }
  },
  'pkSerializer-revoked_tokens_9000': function(getCompositeKeyValue, getPrimaryKeyHash) {
    // compiled pk serializer for entity RevokedTokenEntity
    return function(entity) {
      return '' + entity.id;
    }
  },
  'hydrator-pending_oauth_registration_13000-full-false': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError, convertToJSValue_userInfo, convertToDatabaseValue_userInfo) {
  ...
  'hydrator-pending_oauth_registration_13000-full-true': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError, convertToJSValue_userInfo, convertToDatabaseValue_userInfo) {
    // compiled hydrator for entity PendingOAuthRegistrationEntity ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
  ...
  'snapshotGenerator-pending_oauth_registration_13000': function(clone, cloneEmbeddable, processDateProperty, convertToDatabaseValue_userInfo) {
    return function(entity) {
      const ret = {};
      if (typeof entity.id !== 'undefined') {
        ret.id = clone(entity.id);
  ...
  'hydrator-pending_oauth_registration_13000-reference-false': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError) {
    // compiled hydrator for entity PendingOAuthRegistrationEntity ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
  ...
  'hydrator-pending_oauth_registration_13000-reference-true': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError) {
    // compiled hydrator for entity PendingOAuthRegistrationEntity ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
  ...
  'pkGetterConverted-pending_oauth_registration_13000': function() {
    // compiled pk getter (with converted custom types) for entity PendingOAuthRegistrationEntity
    return function(entity) {
      return entity.id;
    }
  },
  'pkSerializer-pending_oauth_registration_13000': function(getCompositeKeyValue, getPrimaryKeyHash) {
    // compiled pk serializer for entity PendingOAuthRegistrationEntity
    return function(entity) {
      return '' + entity.id;
    }
  },
  'hydrator-password_reset_12000-full-false': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError, user_253, user_254) {
    ...
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      ...
      if (data.user === null) {
        ...
        if (isPrimaryKey(data.user, true)) {
          entity.user = Reference.create(factory.createReference(user_253, data.user, { merge: true, convertCustomTypes, normalizeAccessors, schema }));
        } else if (data.user && typeof data.user === 'object') {
          entity.user = Reference.create(factory.create(user_254, data.user, { initialized: true, merge: true, newEntity, convertCustomTypes, normalizeAccessors, schema }));
        }
      }
      if (data.token === null) {
        entity.token = null;
  ...
  'hydrator-password_reset_12000-full-true': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError, user_262, user_263) {
    // compiled hydrator for entity PasswordResetEntity ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
      ...
      if (data.user === null) {
        ...
        if (isPrimaryKey(data.user, true)) {
          entity.user = Reference.create(factory.createReference(user_262, data.user, { merge: true, convertCustomTypes, normalizeAccessors, schema }));
        } else if (data.user && typeof data.user === 'object') {
          entity.user = Reference.create(factory.create(user_263, data.user, { initialized: true, merge: true, newEntity, convertCustomTypes, normalizeAccessors, schema }));
        }
      }
      if (data.token === null) {
        entity.token = null;
  ...
  'snapshotGenerator-password_reset_12000': function(clone, cloneEmbeddable, processDateProperty, toArray, EntityIdentifier) {
    return function(entity) {
      const ret = {};
      if (typeof entity.id !== 'undefined') {
        ret.id = clone(entity.id);
  ...
  'hydrator-password_reset_12000-reference-false': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError) {
    // compiled hydrator for entity PasswordResetEntity ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
  ...
  'hydrator-password_reset_12000-reference-true': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError) {
    // compiled hydrator for entity PasswordResetEntity ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
  ...
  'pkGetterConverted-password_reset_12000': function() {
    // compiled pk getter (with converted custom types) for entity PasswordResetEntity
    return function(entity) {
      return entity.id;
    }
  },
  'pkSerializer-password_reset_12000': function(getCompositeKeyValue, getPrimaryKeyHash) {
    // compiled pk serializer for entity PasswordResetEntity
    return function(entity) {
      return '' + entity.id;
    }
  },
  'hydrator-oauth_code_8000-full-false': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError, oauth_client_274, oauth_client_275, user_276, user_277, convertToJSValue_scope, convertToDatabaseValue_scope) {
    ...
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      ...
      if (data.client === null) {
        ...
        if (isPrimaryKey(data.client, true)) {
          entity.client = factory.createReference(oauth_client_274, data.client, { merge: true, convertCustomTypes, normalizeAccessors, schema });
        } else if (data.client && typeof data.client === 'object') {
          entity.client = factory.create(oauth_client_275, data.client, { initialized: true, merge: true, newEntity, convertCustomTypes, normalizeAccessors, schema });
        }
      }
      if (data.user === null) {
        entity.user = null;
        ...
        if (isPrimaryKey(data.user, true)) {
          entity.user = Reference.create(factory.createReference(user_276, data.user, { merge: true, convertCustomTypes, normalizeAccessors, schema }));
        } else if (data.user && typeof data.user === 'object') {
          entity.user = Reference.create(factory.create(user_277, data.user, { initialized: true, merge: true, newEntity, convertCustomTypes, normalizeAccessors, schema }));
        }
      }
  ...
  'hydrator-oauth_code_8000-full-true': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError, oauth_client_290, oauth_client_291, user_292, user_293, convertToJSValue_scope, convertToDatabaseValue_scope) {
    // compiled hydrator for entity OAuthCodeEntity ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
      ...
      if (data.client === null) {
        ...
        if (isPrimaryKey(data.client, true)) {
          entity.client = factory.createReference(oauth_client_290, data.client, { merge: true, convertCustomTypes, normalizeAccessors, schema });
        } else if (data.client && typeof data.client === 'object') {
          entity.client = factory.create(oauth_client_291, data.client, { initialized: true, merge: true, newEntity, convertCustomTypes, normalizeAccessors, schema });
        }
      }
      if (data.user === null) {
        entity.user = null;
        ...
        if (isPrimaryKey(data.user, true)) {
          entity.user = Reference.create(factory.createReference(user_292, data.user, { merge: true, convertCustomTypes, normalizeAccessors, schema }));
        } else if (data.user && typeof data.user === 'object') {
          entity.user = Reference.create(factory.create(user_293, data.user, { initialized: true, merge: true, newEntity, convertCustomTypes, normalizeAccessors, schema }));
        }
      }
      if (data.redirectUri === null) {
        entity.redirectUri = null;
  ...
  'snapshotGenerator-oauth_code_8000': function(clone, cloneEmbeddable, processDateProperty, toArray, EntityIdentifier, convertToDatabaseValue_scope) {
    return function(entity) {
      const ret = {};
      if (typeof entity.id !== 'undefined') {
        ret.id = clone(entity.id);
  ...
  'hydrator-oauth_code_8000-reference-false': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError) {
    // compiled hydrator for entity OAuthCodeEntity ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
  ...
  'hydrator-oauth_code_8000-reference-true': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError) {
    // compiled hydrator for entity OAuthCodeEntity ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
  ...
  'pkGetterConverted-oauth_code_8000': function() {
    // compiled pk getter (with converted custom types) for entity OAuthCodeEntity
    return function(entity) {
      return entity.id;
    }
  },
  'pkSerializer-oauth_code_8000': function(getCompositeKeyValue, getPrimaryKeyHash) {
    // compiled pk serializer for entity OAuthCodeEntity
    return function(entity) {
      return '' + entity.id;
    }
  },
  'hydrator-oauth_client_11000-full-false': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError, convertToJSValue_grantTypes, convertToDatabaseValue_grantTypes, convertToJSValue_responseTypes, convertToDatabaseValue_responseTypes, convertToJSValue_scopes, convertToDatabaseValue_scopes, convertToJSValue_redirectUris, convertToDatabaseValue_redirectUris, oauth_code_317, user_consent_318, revoked_tokens_319) {
  ...
  'hydrator-oauth_client_11000-full-true': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError, convertToJSValue_grantTypes, convertToDatabaseValue_grantTypes, convertToJSValue_responseTypes, convertToDatabaseValue_responseTypes, convertToJSValue_scopes, convertToDatabaseValue_scopes, convertToJSValue_redirectUris, convertToDatabaseValue_redirectUris, oauth_code_333, user_consent_334, revoked_tokens_335) {
    // compiled hydrator for entity OAuthClientEntity ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
  ...
  'snapshotGenerator-oauth_client_11000': function(clone, cloneEmbeddable, processDateProperty, convertToDatabaseValue_grantTypes, convertToDatabaseValue_responseTypes, convertToDatabaseValue_scopes, convertToDatabaseValue_redirectUris) {
    return function(entity) {
      const ret = {};
      if (typeof entity.id !== 'undefined') {
        ret.id = clone(entity.id);
  ...
  'hydrator-oauth_client_11000-reference-false': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError) {
    // compiled hydrator for entity OAuthClientEntity ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
  ...
  'hydrator-oauth_client_11000-reference-true': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError) {
    // compiled hydrator for entity OAuthClientEntity ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
  ...
  'pkGetterConverted-oauth_client_11000': function() {
    // compiled pk getter (with converted custom types) for entity OAuthClientEntity
    return function(entity) {
      return entity.id;
    }
  },
  'pkSerializer-oauth_client_11000': function(getCompositeKeyValue, getPrimaryKeyHash) {
  ...
  'hydrator-email_verification_6000-full-false': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError, user_365, user_366) {
    ...
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      ...
      if (data.user === null) {
        ...
        if (isPrimaryKey(data.user, true)) {
          entity.user = Reference.create(factory.createReference(user_365, data.user, { merge: true, convertCustomTypes, normalizeAccessors, schema }));
        } else if (data.user && typeof data.user === 'object') {
          entity.user = Reference.create(factory.create(user_366, data.user, { initialized: true, merge: true, newEntity, convertCustomTypes, normalizeAccessors, schema }));
        }
      }
      if (data.token === null) {
        entity.token = null;
  ...
  'hydrator-email_verification_6000-full-true': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError, user_374, user_375) {
    // compiled hydrator for entity EmailVerificationEntity ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
      ...
      if (data.user === null) {
        ...
        if (isPrimaryKey(data.user, true)) {
          entity.user = Reference.create(factory.createReference(user_374, data.user, { merge: true, convertCustomTypes, normalizeAccessors, schema }));
        } else if (data.user && typeof data.user === 'object') {
          entity.user = Reference.create(factory.create(user_375, data.user, { initialized: true, merge: true, newEntity, convertCustomTypes, normalizeAccessors, schema }));
        }
      }
      if (data.token === null) {
        entity.token = null;
  ...
  'snapshotGenerator-email_verification_6000': function(clone, cloneEmbeddable, processDateProperty, toArray, EntityIdentifier) {
    return function(entity) {
      const ret = {};
      if (typeof entity.id !== 'undefined') {
        ret.id = clone(entity.id);
  ...
  'hydrator-email_verification_6000-reference-false': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError) {
    // compiled hydrator for entity EmailVerificationEntity ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
  ...
  'hydrator-email_verification_6000-reference-true': function(isPrimaryKey, Collection, Reference, PolymorphicRef, ValidationError) {
    // compiled hydrator for entity EmailVerificationEntity ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
  ...
  'pkGetterConverted-email_verification_6000': function() {
    // compiled pk getter (with converted custom types) for entity EmailVerificationEntity
    return function(entity) {
      return entity.id;
    }
  },
  'pkSerializer-email_verification_6000': function(getCompositeKeyValue, getPrimaryKeyHash) {
