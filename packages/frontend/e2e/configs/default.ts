...
/**
 * Port configuration for the default e2e test servers.
 */
...
/**
 * Default backend configuration for e2e tests.
 * Standard password auth, no 2FA, in-memory database.
 */
export const E2E_DEFAULT_CONFIG = {
  app: {
    host: `http://localhost:${E2E_DEFAULT_PORTS.backend}`,
    ...
    frontend: {
      enabled: true,
      mode: 'proxy',
      path: `http://localhost:${E2E_DEFAULT_PORTS.frontend}`,
    },
  },
  logging: {
    level: 'silent',
