...
export async function loader({ context }: Route.LoaderArgs) {
  ...
  await runtime.queryClient.ensureQueryData(
    createAdminTermsQueryOptions(runtime.api, { page: 1, pageSize: 20 }),
  );
  return createRouteLoaderData(runtime.queryClient, {});
}

export default function AdminTermsRoute({ loaderData }: Route.ComponentProps) {
  return (
