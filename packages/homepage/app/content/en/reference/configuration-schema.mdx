...
| Field | Type | Behavior |
| --- | --- | --- |
| `skip_consent` | `boolean` | Default `false`. Administratively preapprove registered scopes, including allowed offline access. `prompt=consent` still requests consent. |
