---
title: Comparison
description: How Issuary compares to other authentication solutions
...
They are all great products that solve their own unique problems. And so does `Issuary`.
...
`Issuary` aims to find the balance between these two extremes.
...
**And Issuary's unique features:**
- UI optimized for B2C user experience
- Profile page where users can manage their own accounts
- Customizable branding to match your brand identity

---

## Comparison table

| Feature | Keycloak | Authentik | PocketID | Issuary |
|---------|----------|-----------|----------|----------|
| OAuth 2.0 / OIDC | ✅ | ✅ | ✅ | ✅ |
| Passkey (WebAuthn) | ✅ | ✅ | ✅ | ✅ |
| Social login | ✅ | ✅ | ❌ | ✅ |
...
## When to choose Issuary?

Issuary is suitable if:
