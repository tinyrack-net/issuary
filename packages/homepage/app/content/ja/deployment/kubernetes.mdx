---
title: Kubernetes
description: Kubernetesに Tinyauthを配布する方法
section: deployment
order: 4
---

このガイドは Kubernetesに `tinyauth`を展開する方法を説明します。 ConfigMap、Secret、Deployment、Service、Ingress、およびデータのクリーンアップのためのCronJob構成について説明します。
...
Kubernetesから `tinyauth`を運営するとき PostgreSQL 使用をお勧めします。
