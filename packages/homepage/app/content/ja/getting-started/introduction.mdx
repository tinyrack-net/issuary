---
title: はじめに
description: Issuaryとは何か、認証の実装にどのように役立つかを学びます。
section: getting-started
order: 0
---

![Issuary コンポーネントの概要](../../../assets/issuary-overview.png)

`Issuary`は **オープンソース認証プロバイダ（OIDC Provider)** ソフトウェアです。ユーザーエクスペリエンスを中心に設計され、迅速で便利なログイン旅程を提供することを目指しています。
