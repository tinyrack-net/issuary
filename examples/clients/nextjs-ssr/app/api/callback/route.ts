...
import { exchangeCodeForTokens } from '#example-nextjs-ssr/lib/oidc-client';
import { assertAuthState } from '#example-nextjs-ssr/lib/validators';
import type { AuthState } from '#example-nextjs-ssr/types/oidc';
