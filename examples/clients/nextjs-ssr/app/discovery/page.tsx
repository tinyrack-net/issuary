...
import { loadEnvConfig } from '#example-nextjs-ssr/lib/env';
import { fetchOpenIDConfiguration } from '#example-nextjs-ssr/lib/oidc-discovery';
import type { JWKS, OpenIDConfiguration } from '#example-nextjs-ssr/types/oidc';
